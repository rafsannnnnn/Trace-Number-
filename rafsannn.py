...
def logo():
    ...
    return Figlet(font="slant").renderText("R A F S A N")

print (gbl + "\t" + logo())

print (gn + "\t Rafsan The Cracker" + rd + "\n\t[&] Coded By RAFSAN" + mag + "\n\t[-] Channel - > " + bl + "https://youtube.com/channel/UCUnHvZ2KR6mdvUzYNSuteUg")

number = input(rd + "[$] Enter your Phone With Country Code\n\t Example : +8801814043852\n " + bl + "\n- >  " + gn )
